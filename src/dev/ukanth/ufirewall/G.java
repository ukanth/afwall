...
public class G extends android.app.Application {
    ...
    public static String[] profiles = {
            "AFWallPrefs", "AFWallProfile1", "AFWallProfile2", "AFWallProfile3"
    };

    /* global preferences */
    // public static boolean alternateStart() { return gPrefs.getBoolean("alternateStart", false); }
    // public static boolean alternateStart(boolean val) { gPrefs.edit().putBoolean("alternateStart",
// val).commit(); return val; }

    public static boolean isRootAvail() {
        return gPrefs.getBoolean(IS_ROOT_AVAIL, false);
    }

    public static boolean isRootAvail(boolean val) {
        gPrefs.edit().putBoolean(IS_ROOT_AVAIL, val).commit();
        return val;
    }
    ...
    public static boolean fixLeak(boolean val) {
        gPrefs.edit().putBoolean(FIX_START_LEAK, val).commit();
        return val;
    }
    ...
    public static boolean disableTaskerToast(boolean val) {
        gPrefs.edit().putBoolean(DISABLE_TASKER_TOAST, val).commit();
        return val;
    }

    public static boolean enableRoam() {
        return gPrefs.getBoolean(ENABLE_ROAM, true);
    }
    ...
    public static boolean enableLAN() {
        return gPrefs.getBoolean(ENABLE_LAN, false);
    }
    ...
    public static boolean enableInbound(boolean val) {
        gPrefs.edit().putBoolean(ENABLE_INBOUND, val).commit();
        return val;
    }
    ...
    public static boolean enableLog(boolean val) {
        gPrefs.edit().putBoolean(ENABLE_LOG, val).commit();
        return val;
    }
    ...
    public static boolean enableConfirm(boolean val) {
        gPrefs.edit().putBoolean(ENABLE_CONFIRM, val).commit();
        return val;
    }
    ...
    public static boolean notifyAppInstall(boolean val) {
        gPrefs.edit().putBoolean(NOTIFY_INSTALL, val).commit();
        return val;
    }
    ...
    public static boolean disableIcons(boolean val) {
        gPrefs.edit().putBoolean(DISABLE_ICONS, val).commit();
        return val;
    }

    public static String ip_path() {
        return gPrefs.getString(IPTABLES_PATH, "2");
    }
    ...
    public static String bb_path() {
        return gPrefs.getString(BUSYBOX_PATH, "2");
    }
    ...
    public static int storedPosition(int val) {
        gPrefs.edit().putInt(PROFILE_STORED_POSITION, val).commit();
        return val;
    }

    public static int sysColor() {
        return gPrefs.getInt(SYSTEM_APP_COLOR, Color.RED);
    }

    public static int sysColor(int val) {
        gPrefs.edit().putInt(SYSTEM_APP_COLOR, val).commit();
        return val;
    }
    ...
    public static boolean applyOnSwitchProfiles(boolean val) {
        gPrefs.edit().putBoolean(PROFILE_SWITCH, val).commit();
        return val;
    }
